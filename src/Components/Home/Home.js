...
const Home = () => {
    return (
        <React.Fragment>
            <Container fluid>
                <Row className="text-white bg-primary text-center">
            ...
            <Container>
                ...
                <ChatOptionParser option="duet" heading="Go Duet" desc="Want some privacy? Join with a friend, share video, images, have fun and more..." />
            </Container>
        </React.Fragment>
    )
}
